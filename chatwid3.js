// Chat Widget Script - Bubbly Design - Webhook Compatible
(function() {
    ...
    const defaultConfig = {
        webhook: {
            url: '',
            route: '',
            responseField: 'output' // Field name in webhook response containing the message
        },
        branding: {
    ...
    // Helper function to extract response text from various formats
    function extractResponseText(data) {
        ...
        const responseField = config.webhook.responseField || 'output';
        ...
        // If nothing worked, return stringified version
    ...
    async function sendMessage(message) {
        const messageData = {
            ...
            chatInput: message,
            message: message, // Alternative field name
            metadata: {
                userId: ""
            }
        };
        ...
        try {
            ...
            errorMessageDiv.textContent = 'عذراً، حدث خطأ. الرجاء المحاولة مرة أخرى.';
